 ...
 <div class="wrap">
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    ...
    <td class="center">
     <a href="reply_message.html" class="inline-block" title="回复"><img src="public/admin/images/icon_title.gif"/></a>
     <a class="inline-block" title="移除"><img src="public/admin/images/icon_drop.gif"/></a>
    </td>
   </tr>
  </table>
  <!-- BatchOperation -->
