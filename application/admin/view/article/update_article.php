...
<div class="wrap">
    ...
    <form action="admin/article/update/id/<?php echo $this->_vars['OneArticle'][0]->id ?>" method="post">
        <table class="list-style">
            <tr>
                <td style="text-align:right;width:15%;">文章名称：</td>
                <td><input type="text" name="post_title" value="<?php echo $this->_vars['OneArticle'][0]->post_title?>" class="textBox length-long"/></td>
            </tr>
            <tr>
                ...
                <td>
                    <select class="textBox" name="post_category">
                        <?php foreach ($this->_vars['AllNav'] as $key => $value){
                            if($value->name==$this->_vars['OneArticle'][0]->post_category)
            ...
            <tr>
                ...
                <td><input type="text" name="post_keyword" value="<?php echo $this->_vars['OneArticle'][0]->post_keyword ?>" class="textBox length-long"/></td>
            </tr>
            <tr>
                <td style="text-align:right;">文章描述：</td>
                <td><input type="text" name="post_describe" value="<?php echo $this->_vars['OneArticle'][0]->post_describe ?>" class="textBox length-long"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    <script id="editor" name="post_content" type="text/plain"><?php echo html_entity_decode($this->_vars['OneArticle'][0]->post_content) ?></script>
                    <!-- 实例化编辑器 -->
            ...
            <tr>
                <td colspan="2" style="text-align: center"><input type="submit" name="send" value="修改文章" class="tdBtn"/></td>
            </tr>
        </table>
    </form>
</div>
